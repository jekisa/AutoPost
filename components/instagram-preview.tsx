...
export function InstagramPreview({ media, caption, mediaType, username }: Props) {
  ...
  return (
    <aside className="rounded-3xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900 sm:p-5">
      ...
      <div className="mx-auto max-w-[22rem] rounded-[2rem] border-[10px] border-slate-950 bg-slate-950 p-1 shadow-2xl shadow-slate-950/20 dark:border-slate-800 dark:bg-slate-800 sm:border-[12px]">
        <div className="mx-auto mb-2 h-1.5 w-16 rounded-full bg-slate-700 dark:bg-slate-600" aria-hidden="true" />
        <div className="overflow-hidden rounded-[1.35rem] border border-slate-200 bg-white dark:border-slate-700 dark:bg-slate-950">
          ...
          <div className="p-3">
            ...
            <p className="mt-3 break-words text-sm leading-5 text-slate-800 dark:text-slate-200">
              ...
              <HighlightedCaption text={caption} emptyText={<span className="text-slate-400">Caption akan tampil di sini...</span>} />
            </p>
